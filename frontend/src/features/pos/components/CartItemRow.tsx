...
const styles: Record<string, React.CSSProperties> = {
  ...
  qtyBtn: { width: 48, height: 48, border: '1px solid #ccc', borderRadius: 8, background: '#f5f5f5', cursor: 'pointer', fontSize: 22, display: 'flex', alignItems: 'center', justifyContent: 'center' },
